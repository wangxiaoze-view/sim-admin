<template>
  ...
  >
    ...
    <VxeColumn type="checkbox" title="ID" width="140"></VxeColumn>
    <VxeColumn field="name" title="Name" sortable></VxeColumn>
    <VxeColumn
      field="sex"
      title="Sex"
      :filters="sexOptions"
    ...
    <VxeColumn
      ...
      sortable
    ></VxeColumn>
    <VxeColumn field="address" title="Address" show-overflow></VxeColumn>
  </VxeTable>
</template>
